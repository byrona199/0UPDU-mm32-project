...
// meter board 1
#define TX_CANID1               0x11
// meter board 2
#define TX_CANID2               0x12
// meter board 3
#define TX_CANID3               0x13

#ifdef METER1
#define TX_CANID                TX_CANID1
#elif defined(METER2)
#define TX_CANID                TX_CANID2
#elif defined(METER3)
#define TX_CANID                TX_CANID3
#else
#define TX_CANID                TX_CANID1
#endif
